        ...
        <section>
            ...
            <nav class="navbar navbar-expand-lg  blur blur-rounded top-0  z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
                <div class="container-fluid">
                    <img src="/img/logo.png" class="mb-2" height="30" alt=""> &nbsp;&nbsp;&nbsp;
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-7">
                                <div class="card-header pb-0 text-start">
                                    <h3 class="font-weight-bolder text-info text-dark">ASTELLAS 2022</h3>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                        ...
                                        <div class="text-center">
                                            <a href="/Register/" type="button" class="btn btn-outline-gray mt-4 w-100 ms-auto"><b style="">¡QUIERO REGISTRARME!</b></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
